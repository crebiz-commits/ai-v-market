...
const TERMS_KO = {
  ...
  sections: [
    { title: "제1조 (목적)", body: '본 약관은 CREAITE(이하 "회사")가 제공하는 AI 시네마 OTT 서비스(이하 "서비스") 이용에 관한 회사와 이용자의 권리·의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.' },
    ...
    { title: "제6조 (수익 분배)", body: "크리에이터에게는 구독료·광고 수익·판매 수익이 정책에 따라 분배됩니다. 정확한 분배 비율은 서비스 내 별도 안내됩니다." },
    { title: "제7조 (서비스 변경·중단)", body: "회사는 운영·기술상의 필요에 따라 서비스 내용을 변경하거나 중단할 수 있으며, 중대한 변경 시 사전 공지합니다." },
    { title: "제8조 (회원 탈퇴 · 계정 삭제)", body: '이용자는 언제든지 마이페이지 → 설정 → 위험 영역에서 계정 삭제를 요청할 수 있습니다. 삭제 요청 후 <span class="font-bold text-white">30일의 유예 기간</span>이 부여되며, 이 기간 동안은 언제든 취소할 수 있습니다. 30일 경과 시 계정 및 모든 개인 데이터(영상·댓글·좋아요·시청 기록·플레이리스트 등)가 영구 삭제됩니다. 단, 전자상거래법 등 관계 법령에 따라 보존이 필요한 결제 기록은 해당 법령에서 정한 기간 동안 보관됩니다.' },
    { title: "제9조 (이용자 데이터 권리)", body: '이용자는 마이페이지 → 설정 → "내 데이터 다운로드"에서 자신의 모든 데이터를 JSON 형식으로 언제든 다운로드할 수 있습니다 (개인정보보호법상 데이터 이동권).' },
    { title: "제10조 (분쟁 해결)", body: "본 약관과 관련된 분쟁은 대한민국 법률을 적용하며, 서울중앙지방법원을 1심 관할 법원으로 합니다." },
  ],
};
...
const TERMS_EN = {
  ...
  sections: [
    { title: "Article 1 (Purpose)", body: 'These Terms set forth the rights, obligations, and responsibilities of CREAITE (the "Company") and users regarding the AI Cinema OTT service (the "Service") provided by the Company, as well as other necessary matters.' },
    ...
    { title: "Article 6 (Revenue Sharing)", body: "Creators receive distributions of subscription, ad, and sales revenue according to the Company's policies. Exact distribution ratios are announced separately within the Service." },
    { title: "Article 7 (Service Changes / Suspension)", body: "The Company may change or suspend service contents for operational or technical reasons. Significant changes will be announced in advance." },
    { title: "Article 8 (Membership Withdrawal · Account Deletion)", body: 'Users may request account deletion at any time via My Page → Settings → Danger Zone. After requesting deletion, a <span class="font-bold text-white">30-day grace period</span> is granted, during which users may cancel the request at any time. After 30 days, the account and all personal data (videos, comments, likes, watch history, playlists, etc.) are permanently deleted. However, payment records required for retention under applicable laws (e.g., e-commerce law) are retained for the period specified by such laws.' },
    { title: "Article 9 (User Data Rights)", body: 'Users may download all of their data in JSON format at any time via My Page → Settings → "Download my data" (right to data portability under personal information protection law).' },
    { title: "Article 10 (Dispute Resolution)", body: "Disputes related to these Terms shall be governed by the laws of the Republic of Korea, with the Seoul Central District Court as the court of first instance." },
  ],
};

...
const POSTS_KO: Post[] = [
  ...
  { id: "2", author: "VideoMaster", avatar: "https://images.unsplash.com/photo-1633743252577-ccb68cbdb6ed?w=100&h=100&fit=crop", title: "3월 챌린지: '미래 도시' 테마 영상 공모", content: "우승 시 프리미엄 6개월 + 홈 히어로 노출! Cyberpunk, 네온, 미래 도시를 주제로 15초 이내 AI 영상을 제작해주세요. 우수작은 메인 피드에 노출됩니다.", category: "챌린지", likes: 891, comments: 156, timestamp: "1일 전" },
...
const CHALLENGES_KO: Challenge[] = [
  { id: "1", title: "미래 도시 챌린지", prize: "프리미엄 6개월+", participants: 342, deadline: getNextDeadline(15), image: "https://images.unsplash.com/photo-1580895456895-cfdf02e4c23f?w=400&h=200&fit=crop", description: "Cyberpunk, 네온, 미래 도시를 주제로 한 15초 이내 AI 영상을 제작해주세요.\n\nBlade Runner, 사이버펑크 2077, 고스트 인 더 셸 같은 작품들에서 영감을 받아 자신만의 미래 도시 비전을 표현해 보세요. 디스토피아든 유토피아든, 어떤 미래를 그리느냐는 자유입니다.\n\n우수작은 CREAITE 메인 피드에 1주일 동안 무료 노출됩니다." },
  { id: "2", title: "자연 다큐멘터리", prize: "프리미엄 3개월", participants: 189, deadline: getNextDeadline(20), image: "https://images.unsplash.com/photo-1551728715-88730314d185?w=400&h=200&fit=crop", description: "BBC Earth 같은 시네마틱 자연 다큐 스타일 영상을 만들어주세요.\n\n광활한 자연의 경이로움, 야생 동물의 생동감 넘치는 순간, 또는 작은 곤충의 미시 세계까지 — 어떤 자연이든 좋습니다. 시네마틱 연출과 감정적 임팩트가 핵심 평가 요소입니다." },
  { id: "3", title: "추상 아트 비주얼", prize: "프리미엄 1개월", participants: 267, deadline: getNextDeadline(25), image: "https://images.unsplash.com/photo-1633743252577-ccb68cbdb6ed?w=400&h=200&fit=crop", description: "추상적 비주얼, 컬러, 모션, 패턴을 활용한 실험적인 영상을 제작하세요.\n\n구체적인 주제 없이도 OK. 음악 시각화, 추상 표현주의, 사이키델릭 아트 등 자유롭게 표현해 주세요. 영상미와 독창성이 평가 기준입니다." },
];

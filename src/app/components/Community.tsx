...
const _UNUSED_POSTS_KO: Post[] = [
  ...
  },
  {
    ...
    content: "매달 열리는 CREAITE 콘테스트! 이달의 테마는 미래 도시입니다. 5분 이내 AI 영상으로 도전하세요. 1등은 프리미엄 6개월 + 홈 히어로 1개월 + 이달의 크리에이터 뱃지, 우수작은 메인 피드에 노출됩니다.",
    category: "챌린지",
    likes: 891,
    comments: 156,
    timestamp: "1일 전"
...
const POSTS_EN: Post[] = [
  ...
  },
  {
    ...
    content: "CREAITE's monthly contest! This month's theme is Future City. Create an AI video up to 5 minutes to enter. 1st place gets 6-month Premium + 1-month Home Hero + Creator of the Month badge, top entries get featured on the home feed.",
    category: "챌린지",
    likes: 891,
    comments: 156,
    timestamp: "1d ago"

...
export function AuthModal({ onClose, initialMode = "signin" }: AuthModalProps) {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // OAuth는 리다이렉트되므로 여기서 onClose 호출하지 않음
    } catch (err: any) {
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-background w-full max-w-md rounded-xl overflow-hidden border border-border shadow-2xl"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="relative bg-gradient-to-r from-[#6366f1] to-[#8b5cf6] p-6 text-white">
          <button
            onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                type="button"
                variant="outline"
                className="w-full gap-2 border-2 hover:bg-[#FEE500]/10 hover:border-[#FEE500]"
              ...
              <Button
                type="button"
                className="w-full gap-2 bg-[#FEE500] text-[#000000] hover:bg-[#FEE500]/90 border-none"
              ...
              >
                ...
                <span className="truncate">카카오</span>
              </Button>
            </div>
          </form>

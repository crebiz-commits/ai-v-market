...
1. **광고주 온보딩**: ✅ **오픈 가입 + 광고별 심사** (진입장벽↓, 품질은 광고 심사로 통제)
2. **충전 시점**: ✅ **승인 후 충전** (미승인 환불 불필요 — 단순)
3. **광고 수익 귀속**: ✅ **크리에이터와 분배(현행 유지)** — `revenue_distributions`의 광고수익 분배 그대로 적용, 크리에이터 유인
4. **광고 포맷**: (미확정 — 권장 MVP는 배너+프리롤)
5. **타게팅**: (미확정 — 권장 MVP는 전체노출, 후속 추가)
6. **최소 충전액 / 심사 SLA**: (미확정 — 권장 최소 ₩10,000, 심사 1영업일)
7. **사업자 정보 수집**: (후속 — MVP는 개인도 가능, 영수증만)

> 확정된 1~3 으로 Phase 1 진행. 4~7 은 Phase 2~3 시점에 확정해도 무방.

...
- [~] 🟡 약관·개인정보 **자체 보강 완료**(2026-06-16) — 누락 법정 고지 추가: 약관 통신판매중개자 지위(전자상거래법 §20)·회사 면책·약관 개정 조항, 관할 소비자 보정(전속관할 → 민소법). 개인정보 만14세미만 미수집·파기 절차·안전성 확보조치(§29)·권익침해 구제(분쟁조정위·KISA). KO·EN 동기화, 개정일 갱신. ("초안" 라벨은 원래 미렌더였음). **최종 변호사 검토는 여전히 권장**(사업 특수상황).

...
### 지식재산(IP)
- [~] 🟡 **상표권 출원 (CREAITE)** — 국내 선등록 0건 확인(2026-06-15). **영문 "CREAITE" 셀프 출원·납부 완료(2026-06-16, 출원번호 40-2026-0120579, 제41·38·42류, ₩138,000)**. 한글 "크리에잇" 동일 류로 출원 예정(남음). 심사 8~14개월. *유사상표 CREAITER(일본 41류) 주의 — 의견제출통지 시 대응 필요.*
...
- [ ] 🟡 약관·개인정보 **"초안" → 변리사/변호사 법무 검토 후 최종본** 대체 (현재 draftNotice 표기 중)

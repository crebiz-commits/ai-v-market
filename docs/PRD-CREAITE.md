...
- 콘텐츠 180+편 적재. **카카오 애드핏 매체심사 승인 → 실광고 노출·수익화 중**(2026-07-07). 무료 광고형 티어는 선출시 가능, **프리미엄 구독·라이선스 실결제는 토스 가맹심사(병목) 후행** — 그동안 `payments_enabled=0` 서버 게이트로 결제 차단(live 전환 시 해제).
